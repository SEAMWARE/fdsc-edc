...
public class TckWebhookController {
  ...
  public void startNegotiation(ContractNegotiationRequest request) {
    ...
    var contractRequest =
        ContractRequest.Builder.newInstance()
            .callbackAddresses(
                List.of(
                    CallbackAddress.Builder.newInstance().uri(request.connectorAddress()).build()))
    ...
    return Policy.Builder.newInstance()
        ...
        .permission(
            Permission.Builder.newInstance()
                .action(
                    Action.Builder.newInstance().type("http://www.w3.org/ns/odrl/2/use").build())
                .build())
        .build();
  }
  ...
  public void startTransfer(TransferProcessRequest request) {
    ...
    var transferRequest =
        TransferRequest.Builder.newInstance()
