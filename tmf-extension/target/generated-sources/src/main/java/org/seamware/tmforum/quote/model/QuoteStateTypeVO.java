...
public enum QuoteStateTypeVO {
  ...
  @JsonCreator
  public static QuoteStateTypeVO fromValue(String value) {
    for (QuoteStateTypeVO b : QuoteStateTypeVO.values()) {
