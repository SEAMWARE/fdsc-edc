...
import org.seamware.tmforum.productinventory.model.ProductAttributeValueChangeEventPayloadVO;
 ...
 */
@JsonPropertyOrder({
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_EVENT_ID,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_EVENT_TIME,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_EVENT_TYPE,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_CORRELATION_ID,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_DOMAIN,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_TITLE,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_DESCRIPTION,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_PRIORITY,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_TIME_OCURRED,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_FIELD_PATH,
  ProductAttributeValueChangeEventVO.JSON_PROPERTY_EVENT
})
...
public class ProductAttributeValueChangeEventVO {
  ...
  public ProductAttributeValueChangeEventVO() { 
  }

  public ProductAttributeValueChangeEventVO eventId(@javax.annotation.Nullable String eventId) {
  ...
  public ProductAttributeValueChangeEventVO eventTime(@javax.annotation.Nullable OffsetDateTime eventTime) {
  ...
  public ProductAttributeValueChangeEventVO eventType(@javax.annotation.Nullable String eventType) {
  ...
  public ProductAttributeValueChangeEventVO correlationId(@javax.annotation.Nullable String correlationId) {
  ...
  public ProductAttributeValueChangeEventVO domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductAttributeValueChangeEventVO title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductAttributeValueChangeEventVO description(@javax.annotation.Nullable String description) {
  ...
  public ProductAttributeValueChangeEventVO priority(@javax.annotation.Nullable String priority) {
  ...
  public ProductAttributeValueChangeEventVO timeOcurred(@javax.annotation.Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductAttributeValueChangeEventVO fieldPath(@javax.annotation.Nullable String fieldPath) {
  ...
  public ProductAttributeValueChangeEventVO event(@javax.annotation.Nullable ProductAttributeValueChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public ProductAttributeValueChangeEventPayloadVO getEvent() {
    return event;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EVENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEvent(@javax.annotation.Nullable ProductAttributeValueChangeEventPayloadVO event) {
    this.event = event;
  }


  /**
   * Return true if this ProductAttributeValueChangeEvent object is equal to o.
   */
  @Override
