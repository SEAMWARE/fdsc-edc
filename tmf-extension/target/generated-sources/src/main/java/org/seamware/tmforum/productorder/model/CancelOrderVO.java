 ...
 */
@JsonPropertyOrder({
  CancelOrderVO.JSON_PROPERTY_ID,
  CancelOrderVO.JSON_PROPERTY_HREF,
  CancelOrderVO.JSON_PROPERTY_CANCELLATION_REASON,
  CancelOrderVO.JSON_PROPERTY_EFFECTIVE_CANCELLATION_DATE,
  CancelOrderVO.JSON_PROPERTY_REQUESTED_CANCELLATION_DATE,
  CancelOrderVO.JSON_PROPERTY_STATE,
  CancelOrderVO.JSON_PROPERTY_AT_BASE_TYPE,
  CancelOrderVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  CancelOrderVO.JSON_PROPERTY_AT_TYPE
})
...
public class CancelOrderVO {
  ...
  public CancelOrderVO id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CancelOrderVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CancelOrderVO cancellationReason(@javax.annotation.Nullable String cancellationReason) {
  ...
  public CancelOrderVO effectiveCancellationDate(@javax.annotation.Nullable OffsetDateTime effectiveCancellationDate) {
  ...
  public CancelOrderVO requestedCancellationDate(@javax.annotation.Nullable OffsetDateTime requestedCancellationDate) {
  ...
  public CancelOrderVO state(@javax.annotation.Nullable TaskStateTypeVO state) {
    this.state = state;
    return this;
  }
  ...
  public CancelOrderVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public CancelOrderVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public CancelOrderVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  /**
   * Return true if this CancelOrder object is equal to o.
   */
  @Override
