 ...
 */
@JsonPropertyOrder({
  ExportJobCreateVO.JSON_PROPERTY_COMPLETION_DATE,
  ExportJobCreateVO.JSON_PROPERTY_CONTENT_TYPE,
  ExportJobCreateVO.JSON_PROPERTY_CREATION_DATE,
  ExportJobCreateVO.JSON_PROPERTY_ERROR_LOG,
  ExportJobCreateVO.JSON_PROPERTY_PATH,
  ExportJobCreateVO.JSON_PROPERTY_QUERY,
  ExportJobCreateVO.JSON_PROPERTY_URL,
  ExportJobCreateVO.JSON_PROPERTY_STATUS,
  ExportJobCreateVO.JSON_PROPERTY_AT_BASE_TYPE,
  ExportJobCreateVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  ExportJobCreateVO.JSON_PROPERTY_AT_TYPE
})
...
public class ExportJobCreateVO {
  ...
  public ExportJobCreateVO() { 
  }

  public ExportJobCreateVO completionDate(@javax.annotation.Nullable OffsetDateTime completionDate) {
  ...
  public ExportJobCreateVO contentType(@javax.annotation.Nullable String contentType) {
  ...
  public ExportJobCreateVO creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public ExportJobCreateVO errorLog(@javax.annotation.Nullable String errorLog) {
  ...
  public ExportJobCreateVO path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public ExportJobCreateVO query(@javax.annotation.Nullable String query) {
    this.query = query;
    return this;
  }
  ...
  public ExportJobCreateVO url(@javax.annotation.Nonnull URI url) {
    this.url = url;
    return this;
  }
  ...
  public ExportJobCreateVO status(@javax.annotation.Nullable JobStateTypeVO status) {
    this.status = status;
    return this;
  }
  ...
  public ExportJobCreateVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public ExportJobCreateVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public ExportJobCreateVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  /**
   * Return true if this ExportJob_Create object is equal to o.
   */
  @Override
