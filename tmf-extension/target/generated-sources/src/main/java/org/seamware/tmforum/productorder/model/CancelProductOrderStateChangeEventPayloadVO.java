...
import org.seamware.tmforum.productorder.model.CancelProductOrderVO;
 ...
 */
@JsonPropertyOrder({
  CancelProductOrderStateChangeEventPayloadVO.JSON_PROPERTY_CANCEL_PRODUCT_ORDER
})
...
public class CancelProductOrderStateChangeEventPayloadVO {
  public static final String JSON_PROPERTY_CANCEL_PRODUCT_ORDER = "cancelProductOrder";
  @javax.annotation.Nullable
  private CancelProductOrderVO cancelProductOrder;

  public CancelProductOrderStateChangeEventPayloadVO() { 
  }

  public CancelProductOrderStateChangeEventPayloadVO cancelProductOrder(@javax.annotation.Nullable CancelProductOrderVO cancelProductOrder) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CANCEL_PRODUCT_ORDER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public CancelProductOrderVO getCancelProductOrder() {
    return cancelProductOrder;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CANCEL_PRODUCT_ORDER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCancelProductOrder(@javax.annotation.Nullable CancelProductOrderVO cancelProductOrder) {
    this.cancelProductOrder = cancelProductOrder;
  }


  /**
   * Return true if this CancelProductOrderStateChangeEventPayload object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CancelProductOrderStateChangeEventPayloadVO cancelProductOrderStateChangeEventPayload = (CancelProductOrderStateChangeEventPayloadVO) o;
  ...
  public String toString() {
    ...
    sb.append("class CancelProductOrderStateChangeEventPayloadVO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `cancelProductOrder` to the URL query string
    if (getCancelProductOrder() != null) {
      joiner.add(getCancelProductOrder().toUrlQueryString(prefix + "cancelProductOrder" + suffix));
    }
