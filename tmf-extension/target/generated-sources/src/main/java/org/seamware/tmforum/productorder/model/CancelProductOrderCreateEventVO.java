...
import org.seamware.tmforum.productorder.model.CancelProductOrderCreateEventPayloadVO;
 ...
 */
@JsonPropertyOrder({
  CancelProductOrderCreateEventVO.JSON_PROPERTY_ID,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_HREF,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_EVENT_ID,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_EVENT_TIME,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_EVENT_TYPE,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_CORRELATION_ID,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_DOMAIN,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_TITLE,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_DESCRIPTION,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_PRIORITY,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_TIME_OCURRED,
  CancelProductOrderCreateEventVO.JSON_PROPERTY_EVENT
})
...
public class CancelProductOrderCreateEventVO {
  ...
  public CancelProductOrderCreateEventVO() { 
  }

  public CancelProductOrderCreateEventVO id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CancelProductOrderCreateEventVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CancelProductOrderCreateEventVO eventId(@javax.annotation.Nullable String eventId) {
  ...
  public CancelProductOrderCreateEventVO eventTime(@javax.annotation.Nullable OffsetDateTime eventTime) {
  ...
  public CancelProductOrderCreateEventVO eventType(@javax.annotation.Nullable String eventType) {
  ...
  public CancelProductOrderCreateEventVO correlationId(@javax.annotation.Nullable String correlationId) {
  ...
  public CancelProductOrderCreateEventVO domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CancelProductOrderCreateEventVO title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CancelProductOrderCreateEventVO description(@javax.annotation.Nullable String description) {
  ...
  public CancelProductOrderCreateEventVO priority(@javax.annotation.Nullable String priority) {
  ...
  public CancelProductOrderCreateEventVO timeOcurred(@javax.annotation.Nullable OffsetDateTime timeOcurred) {
  ...
  public CancelProductOrderCreateEventVO event(@javax.annotation.Nullable CancelProductOrderCreateEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public CancelProductOrderCreateEventPayloadVO getEvent() {
    return event;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EVENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEvent(@javax.annotation.Nullable CancelProductOrderCreateEventPayloadVO event) {
    this.event = event;
  }


  /**
   * Return true if this CancelProductOrderCreateEvent object is equal to o.
   */
  @Override
