 ...
 */
@JsonPropertyOrder({
  ImportJobVO.JSON_PROPERTY_ID,
  ImportJobVO.JSON_PROPERTY_HREF,
  ImportJobVO.JSON_PROPERTY_COMPLETION_DATE,
  ImportJobVO.JSON_PROPERTY_CONTENT_TYPE,
  ImportJobVO.JSON_PROPERTY_CREATION_DATE,
  ImportJobVO.JSON_PROPERTY_ERROR_LOG,
  ImportJobVO.JSON_PROPERTY_PATH,
  ImportJobVO.JSON_PROPERTY_URL,
  ImportJobVO.JSON_PROPERTY_STATUS,
  ImportJobVO.JSON_PROPERTY_AT_BASE_TYPE,
  ImportJobVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  ImportJobVO.JSON_PROPERTY_AT_TYPE
})
...
public class ImportJobVO {
  ...
  public ImportJobVO id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ImportJobVO href(@javax.annotation.Nullable URI href) {
    this.href = href;
    return this;
  }
  ...
  public ImportJobVO completionDate(@javax.annotation.Nullable OffsetDateTime completionDate) {
  ...
  public ImportJobVO contentType(@javax.annotation.Nullable String contentType) {
  ...
  public ImportJobVO creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public ImportJobVO errorLog(@javax.annotation.Nullable String errorLog) {
  ...
  public ImportJobVO path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public ImportJobVO url(@javax.annotation.Nullable URI url) {
    this.url = url;
    return this;
  }
  ...
  public ImportJobVO status(@javax.annotation.Nullable JobStateTypeVO status) {
    this.status = status;
    return this;
  }
  ...
  public ImportJobVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public ImportJobVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public ImportJobVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
