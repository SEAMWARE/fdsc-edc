...
import org.seamware.tmforum.productorder.model.CancelProductOrderInformationRequiredEventPayloadVO;
 ...
 */
@JsonPropertyOrder({
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_EVENT_ID,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_EVENT_TIME,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_EVENT_TYPE,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_CORRELATION_ID,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_DOMAIN,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_TITLE,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_DESCRIPTION,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_PRIORITY,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_TIME_OCURRED,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_FIELD_PATH,
  CancelProductOrderInformationRequiredEventVO.JSON_PROPERTY_EVENT
})
...
public class CancelProductOrderInformationRequiredEventVO {
  ...
  @javax.annotation.Nullable
  private CancelProductOrderInformationRequiredEventPayloadVO event;

  public CancelProductOrderInformationRequiredEventVO() { 
  }

  public CancelProductOrderInformationRequiredEventVO eventId(@javax.annotation.Nullable String eventId) {
  ...
  public CancelProductOrderInformationRequiredEventVO eventTime(@javax.annotation.Nullable OffsetDateTime eventTime) {
  ...
  public CancelProductOrderInformationRequiredEventVO eventType(@javax.annotation.Nullable String eventType) {
  ...
  public CancelProductOrderInformationRequiredEventVO correlationId(@javax.annotation.Nullable String correlationId) {
  ...
  public CancelProductOrderInformationRequiredEventVO domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CancelProductOrderInformationRequiredEventVO title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CancelProductOrderInformationRequiredEventVO description(@javax.annotation.Nullable String description) {
  ...
  public CancelProductOrderInformationRequiredEventVO priority(@javax.annotation.Nullable String priority) {
  ...
  public CancelProductOrderInformationRequiredEventVO timeOcurred(@javax.annotation.Nullable OffsetDateTime timeOcurred) {
  ...
  public CancelProductOrderInformationRequiredEventVO fieldPath(@javax.annotation.Nullable String fieldPath) {
  ...
  public CancelProductOrderInformationRequiredEventVO event(@javax.annotation.Nullable CancelProductOrderInformationRequiredEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public CancelProductOrderInformationRequiredEventPayloadVO getEvent() {
    return event;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EVENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEvent(@javax.annotation.Nullable CancelProductOrderInformationRequiredEventPayloadVO event) {
    this.event = event;
  }


  /**
   * Return true if this CancelProductOrderInformationRequiredEvent object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CancelProductOrderInformationRequiredEventVO cancelProductOrderInformationRequiredEvent = (CancelProductOrderInformationRequiredEventVO) o;
  ...
  public String toString() {
    ...
    sb.append("class CancelProductOrderInformationRequiredEventVO {\n");
