 ...
 */
@JsonPropertyOrder({
  PlaceVO.JSON_PROPERTY_ID,
  PlaceVO.JSON_PROPERTY_HREF,
  PlaceVO.JSON_PROPERTY_NAME,
  PlaceVO.JSON_PROPERTY_AT_BASE_TYPE,
  PlaceVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  PlaceVO.JSON_PROPERTY_AT_TYPE
})
...
public class PlaceVO {
  ...
  public PlaceVO id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PlaceVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PlaceVO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PlaceVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public PlaceVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public PlaceVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
