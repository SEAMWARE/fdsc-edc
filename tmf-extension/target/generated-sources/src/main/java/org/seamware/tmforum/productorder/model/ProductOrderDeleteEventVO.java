...
import org.seamware.tmforum.productorder.model.ProductOrderDeleteEventPayloadVO;
 ...
 */
@JsonPropertyOrder({
  ProductOrderDeleteEventVO.JSON_PROPERTY_ID,
  ProductOrderDeleteEventVO.JSON_PROPERTY_HREF,
  ProductOrderDeleteEventVO.JSON_PROPERTY_EVENT_ID,
  ProductOrderDeleteEventVO.JSON_PROPERTY_EVENT_TIME,
  ProductOrderDeleteEventVO.JSON_PROPERTY_EVENT_TYPE,
  ProductOrderDeleteEventVO.JSON_PROPERTY_CORRELATION_ID,
  ProductOrderDeleteEventVO.JSON_PROPERTY_DOMAIN,
  ProductOrderDeleteEventVO.JSON_PROPERTY_TITLE,
  ProductOrderDeleteEventVO.JSON_PROPERTY_DESCRIPTION,
  ProductOrderDeleteEventVO.JSON_PROPERTY_PRIORITY,
  ProductOrderDeleteEventVO.JSON_PROPERTY_TIME_OCURRED,
  ProductOrderDeleteEventVO.JSON_PROPERTY_EVENT
})
...
public class ProductOrderDeleteEventVO {
  ...
  @javax.annotation.Nullable
  private ProductOrderDeleteEventPayloadVO event;

  public ProductOrderDeleteEventVO() { 
  }

  public ProductOrderDeleteEventVO id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOrderDeleteEventVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOrderDeleteEventVO eventId(@javax.annotation.Nullable String eventId) {
  ...
  public ProductOrderDeleteEventVO eventTime(@javax.annotation.Nullable OffsetDateTime eventTime) {
  ...
  public ProductOrderDeleteEventVO eventType(@javax.annotation.Nullable String eventType) {
  ...
  public ProductOrderDeleteEventVO correlationId(@javax.annotation.Nullable String correlationId) {
  ...
  public ProductOrderDeleteEventVO domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOrderDeleteEventVO title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOrderDeleteEventVO description(@javax.annotation.Nullable String description) {
  ...
  public ProductOrderDeleteEventVO priority(@javax.annotation.Nullable String priority) {
  ...
  public ProductOrderDeleteEventVO timeOcurred(@javax.annotation.Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOrderDeleteEventVO event(@javax.annotation.Nullable ProductOrderDeleteEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public ProductOrderDeleteEventPayloadVO getEvent() {
    return event;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EVENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEvent(@javax.annotation.Nullable ProductOrderDeleteEventPayloadVO event) {
    this.event = event;
  }


  /**
   * Return true if this ProductOrderDeleteEvent object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ProductOrderDeleteEventVO productOrderDeleteEvent = (ProductOrderDeleteEventVO) o;
  ...
  public String toString() {
    ...
    sb.append("class ProductOrderDeleteEventVO {\n");
