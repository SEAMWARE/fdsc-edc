...
import org.seamware.tmforum.quote.model.TargetProductSchemaVO;
 ...
 */
@JsonPropertyOrder({
  ProductSpecificationRefVO.JSON_PROPERTY_ID,
  ProductSpecificationRefVO.JSON_PROPERTY_HREF,
  ProductSpecificationRefVO.JSON_PROPERTY_NAME,
  ProductSpecificationRefVO.JSON_PROPERTY_VERSION,
  ProductSpecificationRefVO.JSON_PROPERTY_TARGET_PRODUCT_SCHEMA,
  ProductSpecificationRefVO.JSON_PROPERTY_AT_BASE_TYPE,
  ProductSpecificationRefVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  ProductSpecificationRefVO.JSON_PROPERTY_AT_TYPE,
  ProductSpecificationRefVO.JSON_PROPERTY_AT_REFERRED_TYPE
})
...
public class ProductSpecificationRefVO {
  ...
  public ProductSpecificationRefVO() { 
  }

  public ProductSpecificationRefVO id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductSpecificationRefVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductSpecificationRefVO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductSpecificationRefVO version(@javax.annotation.Nullable String version) {
  ...
  public ProductSpecificationRefVO targetProductSchema(@javax.annotation.Nullable TargetProductSchemaVO targetProductSchema) {
  ...
  public ProductSpecificationRefVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public ProductSpecificationRefVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public ProductSpecificationRefVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ProductSpecificationRefVO atReferredType(@javax.annotation.Nullable String atReferredType) {
  ...
  /**
   * Return true if this ProductSpecificationRef object is equal to o.
   */
  @Override
