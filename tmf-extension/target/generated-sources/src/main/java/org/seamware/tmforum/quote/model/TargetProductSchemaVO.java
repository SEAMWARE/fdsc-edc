 ...
 */
@JsonPropertyOrder({
  TargetProductSchemaVO.JSON_PROPERTY_AT_BASE_TYPE,
...
public class TargetProductSchemaVO {
  ...
  public TargetProductSchemaVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public TargetProductSchemaVO atSchemaLocation(@javax.annotation.Nonnull String atSchemaLocation) {
