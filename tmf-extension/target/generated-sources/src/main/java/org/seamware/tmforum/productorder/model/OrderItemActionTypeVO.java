 ...
 */
public enum OrderItemActionTypeVO {
  ...
  OrderItemActionTypeVO(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static OrderItemActionTypeVO fromValue(String value) {
    for (OrderItemActionTypeVO b : OrderItemActionTypeVO.values()) {
