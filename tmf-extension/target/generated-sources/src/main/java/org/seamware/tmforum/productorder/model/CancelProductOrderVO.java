...
import org.seamware.tmforum.productorder.model.TaskStateTypeVO;
 ...
 */
@JsonPropertyOrder({
  CancelProductOrderVO.JSON_PROPERTY_ID,
  CancelProductOrderVO.JSON_PROPERTY_HREF,
  CancelProductOrderVO.JSON_PROPERTY_CANCELLATION_REASON,
  CancelProductOrderVO.JSON_PROPERTY_EFFECTIVE_CANCELLATION_DATE,
  CancelProductOrderVO.JSON_PROPERTY_REQUESTED_CANCELLATION_DATE,
  CancelProductOrderVO.JSON_PROPERTY_PRODUCT_ORDER,
  CancelProductOrderVO.JSON_PROPERTY_STATE,
  CancelProductOrderVO.JSON_PROPERTY_AT_BASE_TYPE,
  CancelProductOrderVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  CancelProductOrderVO.JSON_PROPERTY_AT_TYPE
})
...
public class CancelProductOrderVO {
  ...
  public CancelProductOrderVO() { 
  }

  public CancelProductOrderVO id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CancelProductOrderVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CancelProductOrderVO cancellationReason(@javax.annotation.Nullable String cancellationReason) {
  ...
  public CancelProductOrderVO effectiveCancellationDate(@javax.annotation.Nullable OffsetDateTime effectiveCancellationDate) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_EFFECTIVE_CANCELLATION_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_EFFECTIVE_CANCELLATION_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEffectiveCancellationDate(@javax.annotation.Nullable OffsetDateTime effectiveCancellationDate) {
    this.effectiveCancellationDate = effectiveCancellationDate;
  }


  public CancelProductOrderVO requestedCancellationDate(@javax.annotation.Nullable OffsetDateTime requestedCancellationDate) {
  ...
  public CancelProductOrderVO productOrder(@javax.annotation.Nonnull ProductOrderRefVO productOrder) {
  ...
  public CancelProductOrderVO state(@javax.annotation.Nullable TaskStateTypeVO state) {
    this.state = state;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_STATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setState(@javax.annotation.Nullable TaskStateTypeVO state) {
    this.state = state;
  }


  public CancelProductOrderVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public CancelProductOrderVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public CancelProductOrderVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  /**
   * Return true if this CancelProductOrder object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CancelProductOrderVO cancelProductOrder = (CancelProductOrderVO) o;
  ...
  public String toString() {
    ...
    sb.append("class CancelProductOrderVO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `effectiveCancellationDate` to the URL query string
    if (getEffectiveCancellationDate() != null) {
      joiner.add(String.format("%seffectiveCancellationDate%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEffectiveCancellationDate()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
