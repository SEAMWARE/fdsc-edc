 ...
 */
@JsonPropertyOrder({
  BillingAccountRefVO.JSON_PROPERTY_ID,
  BillingAccountRefVO.JSON_PROPERTY_HREF,
  BillingAccountRefVO.JSON_PROPERTY_NAME,
  BillingAccountRefVO.JSON_PROPERTY_AT_BASE_TYPE,
  BillingAccountRefVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  BillingAccountRefVO.JSON_PROPERTY_AT_TYPE,
  BillingAccountRefVO.JSON_PROPERTY_AT_REFERRED_TYPE
})
...
public class BillingAccountRefVO {
  ...
  public BillingAccountRefVO() { 
  }

  public BillingAccountRefVO id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public BillingAccountRefVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public BillingAccountRefVO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public BillingAccountRefVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public BillingAccountRefVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public BillingAccountRefVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public BillingAccountRefVO atReferredType(@javax.annotation.Nullable String atReferredType) {
