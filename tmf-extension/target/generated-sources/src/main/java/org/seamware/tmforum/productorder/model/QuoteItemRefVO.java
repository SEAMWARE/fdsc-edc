 ...
 */
@JsonPropertyOrder({
  QuoteItemRefVO.JSON_PROPERTY_ID,
  QuoteItemRefVO.JSON_PROPERTY_HREF,
  QuoteItemRefVO.JSON_PROPERTY_NAME,
  QuoteItemRefVO.JSON_PROPERTY_QUOTE_HREF,
  QuoteItemRefVO.JSON_PROPERTY_QUOTE_ID,
  QuoteItemRefVO.JSON_PROPERTY_QUOTE_NAME,
  QuoteItemRefVO.JSON_PROPERTY_AT_BASE_TYPE,
  QuoteItemRefVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  QuoteItemRefVO.JSON_PROPERTY_AT_TYPE,
  QuoteItemRefVO.JSON_PROPERTY_AT_REFERRED_TYPE
})
...
public class QuoteItemRefVO {
  ...
  public static final String JSON_PROPERTY_QUOTE_HREF = "quoteHref";
  @javax.annotation.Nullable
  ...
  public static final String JSON_PROPERTY_QUOTE_NAME = "quoteName";
  @javax.annotation.Nullable
  ...
  public QuoteItemRefVO() { 
  }

  public QuoteItemRefVO id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public QuoteItemRefVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public QuoteItemRefVO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public QuoteItemRefVO quoteHref(@javax.annotation.Nullable String quoteHref) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_QUOTE_HREF)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_QUOTE_HREF)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setQuoteHref(@javax.annotation.Nullable String quoteHref) {
    this.quoteHref = quoteHref;
  }


  public QuoteItemRefVO quoteId(@javax.annotation.Nonnull String quoteId) {
  ...
  public QuoteItemRefVO quoteName(@javax.annotation.Nullable String quoteName) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_QUOTE_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public QuoteItemRefVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public QuoteItemRefVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public QuoteItemRefVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public QuoteItemRefVO atReferredType(@javax.annotation.Nullable String atReferredType) {
  ...
  /**
   * Return true if this QuoteItemRef object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `quoteHref` to the URL query string
    if (getQuoteHref() != null) {
      joiner.add(String.format("%squoteHref%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getQuoteHref()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `quoteName` to the URL query string
    if (getQuoteName() != null) {
      joiner.add(String.format("%squoteName%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getQuoteName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
