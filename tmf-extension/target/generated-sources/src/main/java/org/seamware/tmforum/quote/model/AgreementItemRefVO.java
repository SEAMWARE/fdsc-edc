 ...
 */
@JsonPropertyOrder({
  AgreementItemRefVO.JSON_PROPERTY_ID,
  AgreementItemRefVO.JSON_PROPERTY_HREF,
  AgreementItemRefVO.JSON_PROPERTY_AGREEMENT_ITEM_ID,
  AgreementItemRefVO.JSON_PROPERTY_NAME,
  AgreementItemRefVO.JSON_PROPERTY_AT_BASE_TYPE,
  AgreementItemRefVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
  AgreementItemRefVO.JSON_PROPERTY_AT_TYPE,
  AgreementItemRefVO.JSON_PROPERTY_AT_REFERRED_TYPE
})
...
public class AgreementItemRefVO {
  ...
  public static final String JSON_PROPERTY_AGREEMENT_ITEM_ID = "agreementItemId";
  @javax.annotation.Nullable
  ...
  public AgreementItemRefVO() { 
  }

  public AgreementItemRefVO id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public AgreementItemRefVO href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AgreementItemRefVO agreementItemId(@javax.annotation.Nullable String agreementItemId) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AGREEMENT_ITEM_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_AGREEMENT_ITEM_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAgreementItemId(@javax.annotation.Nullable String agreementItemId) {
    this.agreementItemId = agreementItemId;
  }


  public AgreementItemRefVO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AgreementItemRefVO atBaseType(@javax.annotation.Nullable String atBaseType) {
  ...
  public AgreementItemRefVO atSchemaLocation(@javax.annotation.Nullable URI atSchemaLocation) {
  ...
  public AgreementItemRefVO atType(@javax.annotation.Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public AgreementItemRefVO atReferredType(@javax.annotation.Nullable String atReferredType) {
  ...
  /**
   * Return true if this AgreementItemRef object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AgreementItemRefVO agreementItemRef = (AgreementItemRefVO) o;
  ...
  public String toString() {
    ...
    sb.append("class AgreementItemRefVO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `agreementItemId` to the URL query string
    if (getAgreementItemId() != null) {
      joiner.add(String.format("%sagreementItemId%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAgreementItemId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
