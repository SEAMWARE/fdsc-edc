 ...
 */
@JsonPropertyOrder({
  DurationVO.JSON_PROPERTY_AMOUNT,
  DurationVO.JSON_PROPERTY_UNITS
})
...
public class DurationVO {
  ...
  public DurationVO amount(@javax.annotation.Nullable Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public DurationVO units(@javax.annotation.Nullable String units) {
    this.units = units;
    return this;
  }
