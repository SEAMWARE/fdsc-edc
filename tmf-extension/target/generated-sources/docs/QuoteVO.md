...
|**href** | **String** | Hyperlink to access the quote |  [optional] |
...
|**effectiveQuoteCompletionDate** | **OffsetDateTime** | Date when the quote has been completed |  [optional] |
...
|**expectedQuoteCompletionDate** | **OffsetDateTime** | This is expected date - from quote supplier - to be able to send back  a response for this quote |  [optional] |
...
|**quoteDate** | **OffsetDateTime** | Date and time when the quote was created |  [optional] |
...
|**quoteTotalPrice** | [**List&lt;QuotePriceVO&gt;**](QuotePriceVO.md) | Quote total price |  [optional] |
...
|**state** | **QuoteStateTypeVO** |  |  [optional] |
