...
public class ProductCatalogApiClientTest extends AbstractApiTest {
  ...
  public void setupConcreteClient(String baseUrl) {
    ...
    productCatalogApiClient =
        new ProductCatalogApiClient(monitor, okHttpClient, baseUrl, objectMapper, tmfEdcMapper);
  }
  ...
  public void testGetProductOfferings_success() throws Exception {
    ...
    assertEquals(
        testOfferings,
        productCatalogApiClient.getProductOfferings(0, 5),
        "All offering should have been returned.");
  ...
  public void testGetProductSpecifications_success() throws Exception {
    ...
    assertEquals(
        testSpecs,
        productCatalogApiClient.getProductSpecifications(0, 5),
        "All specs should have been returned.");
  ...
  public void testGetProductSpecification_success() throws Exception {
    ...
    assertEquals(
        testSpec,
        productCatalogApiClient.getProductSpecification(TEST_SPEC_ID),
        "The spec should have been returned.");
  ...
  public void testGetByPolicyId_success(
      String name,
      List<ExtendableProductOffering> mockOfferings,
      String requestedPolicyId,
      Optional<Policy> expectedPolicy)
      throws Exception {

    when(tmfEdcMapper.fromOdrl(any()))
        .thenAnswer(
            invocation -> {
              Map<String, Object> policyMap = invocation.getArgument(0);
              Object policyId =
                  ((Map<String, Object>) policyMap.get("extensibleProperties"))
                      .get("http://www.w3.org/ns/odrl/2/uid");
    ...
    if (expectedPolicy.isPresent()) {
      assertEquals(
          expectedPolicy.get(), returnedPolicy.get(), "The correct policy should be returned.");
    }
  }
  ...
  private static Stream<Arguments> getValidPolicyConfigs() {
    return Stream.of(
        Arguments.of(
            ...
            List.of(
                getOfferingWithPolicy(
                    new ContractDefintion(getTestPolicy("access"), getTestPolicy("contract")))),
            "access",
        ...
        Arguments.of(
            ...
            List.of(
                getOfferingWithPolicy(
                    new ContractDefintion(
                        getTestPolicy("other-access"), getTestPolicy("other-contract"))),
                getOfferingWithPolicy(
                    new ContractDefintion(getTestPolicy("access"), getTestPolicy("contract")))),
            "access",
            Optional.of(getTestPolicy("access"))),
  ...
  public void testGetByPolicyId_duplicate_id() throws Exception {
    ...
    assertThrows(
        BadGatewayException.class,
        () -> productCatalogApiClient.getByPolicyId("access"),
  ...
  public void testGetByPolicyId_invalid_content() throws Exception {
    ...
    assertThrows(
        BadGatewayException.class,
        () -> productCatalogApiClient.getByPolicyId("test-policy"),
        "If the server returns something invalid, a BadGateWay should be thrown.");
  }
  ...
  public void testGetProductSpecByExternalId_success() throws Exception {
    ...
    assertEquals(
        testSpec,
        productCatalogApiClient.getProductSpecByExternalId(TEST_ASSET_ID).get(),
        "The correct spec should be returned.");
  ...
  public void testGetProductSpecByExternalId_success_no_spec() throws Exception {
    mockResponse(200, List.of());
    assertTrue(
        productCatalogApiClient.getProductSpecByExternalId(TEST_ASSET_ID).isEmpty(),
        "No spec should have been returned.");
  ...
  public void testGetProductSpecByExternalId_failure_to_many_specs() throws Exception {
    ...
    assertThrows(
        BadGatewayException.class,
        () -> productCatalogApiClient.getProductSpecByExternalId(TEST_ASSET_ID),
        "If the server returns something invalid, a BadGateWay should be thrown.");
  }
  ...
  public void testGetProductOfferingByExternalId_success() throws Exception {
    ...
    assertEquals(
        testOffering,
        productCatalogApiClient.getProductOfferingByExternalId(TEST_ASSET_ID).get(),
        "The correct offer should be returned.");
  ...
  public void testGetProductOfferingByExternalId_success_no_spec() throws Exception {
    mockResponse(200, List.of());
    assertTrue(
        productCatalogApiClient.getProductOfferingByExternalId(TEST_ASSET_ID).isEmpty(),
        "No offer should have been returned.");
  ...
  public void testGetProductOfferingByExternalId_failure_to_many_offers() throws Exception {
    ...
    assertThrows(
        BadGatewayException.class,
        () -> productCatalogApiClient.getProductOfferingByExternalId(TEST_ASSET_ID),
        "If the server returns something invalid, a BadGateWay should be thrown.");
  }
  ...
  private static ExtendableProductSpecification getProductSpecification() {
    ExtendableProductSpecification extendableProductSpecification =
        new ExtendableProductSpecification();
  ...
  protected static ExtendableProductOffering getOfferingWithPolicy(
      ContractDefintion contractDefintion) {
    ...
    extendableProductOfferingTerm.setAtSchemaLocation(
        URI.create("http://base.uri/contract-definition.json"));
    extendableProductOfferingTerm.setName("edc:contractDefinition");
    extendableProductOfferingTerm.setAdditionalProperties(
        "accessPolicy", contractDefintion.accessPolicy());
    extendableProductOfferingTerm.setAdditionalProperties(
        "contractPolicy", contractDefintion.contractPolicy());
    extendableProductOffering.setExtendableProductOfferingTerm(
        List.of(extendableProductOfferingTerm));
    return extendableProductOffering;
  }
