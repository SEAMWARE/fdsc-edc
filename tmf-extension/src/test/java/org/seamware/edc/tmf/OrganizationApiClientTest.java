...
public class OrganizationApiClientTest extends AbstractApiTest {
  ...
  public void testGetOrganization_success() throws Exception {
    ...
    assertEquals(
        testOrganization,
        organizationApiClient.getOrganization(TEST_ORGANIZATION_ID),
  ...
  public void testGetByDid_success_no_org() throws Exception {
    ...
    assertTrue(
        organizationApiClient.getByDid(TEST_ORGANIZATION_DID).isEmpty(),
  ...
  public void testGetByDid_invalid_content() throws Exception {
    ...
    assertThrows(
        BadGatewayException.class,
        () -> organizationApiClient.getByDid(TEST_ORGANIZATION_DID),
        "If the server returns something invalid, a BadGateWay should be thrown.");
  }
  ...
  public void testCreateOrganization_success() throws Exception {
    ...
    assertEquals(
        testOrganization,
        organizationApiClient.createOrganization(testCreate),
        "The correct organization should be returned.");

    RecordedRequest recordedRequest = mockWebServer.takeRequest();
    assertEquals("/organization", recordedRequest.getPath());

    OrganizationCreateVO sentOrganization =
        objectMapper.readValue(
            recordedRequest.getBody().readByteArray(), OrganizationCreateVO.class);
  ...
  public void testCreateOrganization_invalid_content() throws Exception {
    ...
    assertThrows(
        BadGatewayException.class,
        () -> organizationApiClient.createOrganization(getOrganizationCreate()),
        "If the server returns something invalid, a BadGateWay should be thrown.");
  }
