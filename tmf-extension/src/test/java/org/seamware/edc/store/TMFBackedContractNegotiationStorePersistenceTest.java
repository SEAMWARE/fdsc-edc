...
public class TMFBackedContractNegotiationStorePersistenceTest extends TMFBackedContractNegotiationStoreTest {
    ...
    public void testInitialSave_success_update(String name, ContractNegotiation contractNegotiation, List<ExtendableQuoteVO> negotiationQuotes, List<ExtendableQuoteItemVO> quoteItems, String expectedQuoteId, ExtendableQuoteUpdateVO expectedUpdate) {
        ...
        assertEquals(expectedUpdate.getExtendableQuoteItem(), extendableQuoteUpdateVO.getExtendableQuoteItem(), "The offerid should be set for the quote item.");
    }
    ...
    public void testSave_quote_api_error(ContractNegotiationStates negotiationState) {
        when(quoteApiClient.findByNegotiationId(any())).thenThrow(new RuntimeException("Something bad."));

        assertThrows(EdcPersistenceException.class, () -> tmfBackedContractNegotiationStore.save(getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, negotiationState)), "All unexpected errors have to become EdcPersistenceExceptions.");
        verify(leaseHolder, times(1)).freeLease(eq(TEST_NEGOTIATION_ID), any());
    }

    @ParameterizedTest
    @EnumSource(value = ContractNegotiationStates.class, names = {"AGREEING", "AGREED", "VERIFYING", "VERIFIED", "FINALIZING", "FINALIZED"})
    ...
    public void testSave_no_active_quote(ContractNegotiationStates negotiationState, List<ContractNegotiationStates> illegalStates) {
        illegalStates
                .forEach(illegalState -> {
                    String negotiationId = String.format("NEGOTIATION-%s", illegalState.name());
                    when(quoteApiClient.findByNegotiationId(eq(negotiationId))).thenReturn(setActiveQuote(illegalState, "active-id", getQuotes(negotiationId, TEST_CONTROL_PLANE_ID, 5)));
                    EdcPersistenceException edcPersistenceException = assertThrows(EdcPersistenceException.class, () -> tmfBackedContractNegotiationStore.save(getValidNegotiationWithIdInState(negotiationId, negotiationState)), String.format("[%s] All unexpected errors have to become EdcPersistenceExceptions.", illegalState));
                    verify(leaseHolder, times(1)).freeLease(eq(negotiationId), any());
                    assertEquals(IllegalArgumentException.class, edcPersistenceException.getCause().getClass(), String.format("[%s] No active quote should lead to an IllegalArgument.", illegalState));
                });

    }

    @ParameterizedTest
    @EnumSource(value = ContractNegotiationStates.class, names = {"FINALIZING", "FINALIZED"})
    public void testSave_no_order(ContractNegotiationStates contractNegotiationState) {
        when(quoteApiClient.findByNegotiationId(any()))
                .thenReturn(
                        setActiveQuote(ContractNegotiationStates.VERIFIED, "active-id",
                                getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED, TEST_OFFER_ID));
        when(productOrderApiClient.findByQuoteId(any())).thenReturn(List.of());
        EdcPersistenceException edcPersistenceException = assertThrows(EdcPersistenceException.class,
                () -> tmfBackedContractNegotiationStore.save(getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, contractNegotiationState)), "All unexpected errors have to become EdcPersistenceExceptions.");
        verify(leaseHolder, times(1)).freeLease(eq(TEST_NEGOTIATION_ID), any());
        assertEquals(IllegalArgumentException.class, edcPersistenceException.getCause().getClass(), "No order should lead to an IllegalArgument.");
    }
    ...
    public void testSave_to_much_orders(ContractNegotiationStates contractNegotiationState) {
        when(quoteApiClient.findByNegotiationId(any()))
                .thenReturn(
                        setActiveQuote(ContractNegotiationStates.VERIFIED, "active-id",
                                getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED, TEST_OFFER_ID));
        when(productOrderApiClient.findByQuoteId(any())).thenReturn(List.of(new ProductOrderVO(), new ProductOrderVO()));
        EdcPersistenceException edcPersistenceException = assertThrows(EdcPersistenceException.class,
                () -> tmfBackedContractNegotiationStore.save(getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, contractNegotiationState)), "All unexpected errors have to become EdcPersistenceExceptions.");
        verify(leaseHolder, times(1)).freeLease(eq(TEST_NEGOTIATION_ID), any());
        assertEquals(IllegalArgumentException.class, edcPersistenceException.getCause().getClass(), "No order should lead to an IllegalArgument.");
    ...
    public void testSave_order_client_error(ContractNegotiationStates contractNegotiationState) {
        when(quoteApiClient.findByNegotiationId(any()))
                .thenReturn(
                        setActiveQuote(ContractNegotiationStates.VERIFIED, "active-id",
                                getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED, TEST_OFFER_ID));
        when(productOrderApiClient.findByQuoteId(any())).thenThrow(new RuntimeException("Client error"));
        EdcPersistenceException edcPersistenceException = assertThrows(EdcPersistenceException.class,
                () -> tmfBackedContractNegotiationStore.save(getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, contractNegotiationState)), "All unexpected errors have to become EdcPersistenceExceptions.");
        verify(leaseHolder, times(1)).freeLease(eq(TEST_NEGOTIATION_ID), any());
        assertEquals(RuntimeException.class, edcPersistenceException.getCause().getClass(), "In case of a client issue, the client exception needs to be the cause.");
    }
    ...
    private static Stream<Arguments> getInvalidStateCombinations() {
        return Stream.of(
                Arguments.of(
                        ...
                        List.of(ContractNegotiationStates.INITIAL, ContractNegotiationStates.REQUESTING, ContractNegotiationStates.VERIFYING, ContractNegotiationStates.VERIFIED, ContractNegotiationStates.FINALIZING, ContractNegotiationStates.FINALIZED, ContractNegotiationStates.TERMINATING, ContractNegotiationStates.TERMINATED)
                ),
                Arguments.of(
                ...
                Arguments.of(
                        ...
                        List.of(ContractNegotiationStates.INITIAL, ContractNegotiationStates.REQUESTING, ContractNegotiationStates.REQUESTED, ContractNegotiationStates.OFFERING, ContractNegotiationStates.OFFERED, ContractNegotiationStates.ACCEPTING, ContractNegotiationStates.ACCEPTED, ContractNegotiationStates.AGREEING, ContractNegotiationStates.FINALIZING, ContractNegotiationStates.FINALIZED, ContractNegotiationStates.TERMINATING, ContractNegotiationStates.TERMINATED)
                ),
                Arguments.of(
                ...
                Arguments.of(
                        ...
                        List.of(ContractNegotiationStates.INITIAL, ContractNegotiationStates.REQUESTING, ContractNegotiationStates.REQUESTED, ContractNegotiationStates.OFFERING, ContractNegotiationStates.OFFERED, ContractNegotiationStates.ACCEPTING, ContractNegotiationStates.ACCEPTED, ContractNegotiationStates.AGREEING, ContractNegotiationStates.AGREED, ContractNegotiationStates.VERIFYING, ContractNegotiationStates.TERMINATING, ContractNegotiationStates.TERMINATED)
                ),
                Arguments.of(
    ...
    private static Stream<Arguments> getInitialStates_update() {
        return Stream.of(
                Arguments.of("[Provider]The initial state should properly be stored.",
                ...
                Arguments.of("[Provider]The initial state should be stored with all offers included as quote items.",
                ...
                Arguments.of("[Consumer]The initial state should properly be stored.",
                ...
                Arguments.of("[Consumer]The initial state should be stored with all offers included as quote items.",
                ...
                Arguments.of("[Consumer]The requesting state should properly be stored.",
                ...
                Arguments.of("[Consumer]The requesting state should be stored with all offers included as quote items.",
                ...
                Arguments.of("[Provider]The requesting state should properly be stored.",
                ...
                Arguments.of("[Provider]The requesting state should be stored with all offers included as quote items.",
    ...
    private static Stream<Arguments> getInitialStates_create() {
        return Stream.of(
                ...
                Arguments.of("[Provider]The state should be stored with all offers included as quote items.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123"), getOffer(TEST_OFFER_ID + ":asset:124")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.INITIAL),
                        List.of(),
                        List.of(getQuoteItem("123"), getQuoteItem("124")),
                        expectedQuoteCreate("INITIAL", List.of(getQuoteItem("123"), getQuoteItem("124")))
                ),
                Arguments.of("[Consumer]The initial state should properly be stored in initial.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.CONSUMER, ContractNegotiationStates.INITIAL),
                        List.of(),
                        List.of(getQuoteItem("123")),
                        expectedQuoteCreate("INITIAL", List.of(getQuoteItem("123")))
                ),
                Arguments.of("[Consumer]The state should be stored in initial with all offers included as quote items.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123"), getOffer(TEST_OFFER_ID + ":asset:124")), ContractNegotiation.Type.CONSUMER, ContractNegotiationStates.INITIAL),
                        List.of(),
                        List.of(getQuoteItem("123"), getQuoteItem("124")),
                        expectedQuoteCreate("INITIAL", List.of(getQuoteItem("123"), getQuoteItem("124")))
                ),
                Arguments.of("[Consumer]The initial state should properly be stored in requesting.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.CONSUMER, ContractNegotiationStates.REQUESTING),
                        List.of(),
                        List.of(getQuoteItem("123")),
                        expectedQuoteCreate("REQUESTING", List.of(getQuoteItem("123")))
                ),
                Arguments.of("[Consumer]The state should be stored in requesting with all offers included as quote items.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123"), getOffer(TEST_OFFER_ID + ":asset:124")), ContractNegotiation.Type.CONSUMER, ContractNegotiationStates.REQUESTING),
                        List.of(),
                        List.of(getQuoteItem("123"), getQuoteItem("124")),
                        expectedQuoteCreate("REQUESTING", List.of(getQuoteItem("123"), getQuoteItem("124")))
                ),
                Arguments.of("[Provider]The initial state should properly be stored in requesting.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.REQUESTING),
                        List.of(),
                        List.of(getQuoteItem("123")),
                        expectedQuoteCreate("REQUESTING", List.of(getQuoteItem("123")))
                ),
                Arguments.of("[Provider]The state should be stored in requesting with all offers included as quote items.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123"), getOffer(TEST_OFFER_ID + ":asset:124")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.REQUESTING),
                        List.of(),
                        List.of(getQuoteItem("123"), getQuoteItem("124")),
                        expectedQuoteCreate("REQUESTING", List.of(getQuoteItem("123"), getQuoteItem("124")))
                ),
                Arguments.of("[Provider]The state should be stored with all offers included as quote items for counter offers from offering.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123"), getOffer(TEST_OFFER_ID + ":asset:124")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.REQUESTING),
                        setActiveQuote(ContractNegotiationStates.OFFERING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5)),
                        List.of(getQuoteItem("123"), getQuoteItem("124")),
                        expectedQuoteCreate("REQUESTING", List.of(getQuoteItem("123"), getQuoteItem("124")))
                ),
                Arguments.of("[Provider]The state should be stored with all offers included as quote items for counter offers from offered.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123"), getOffer(TEST_OFFER_ID + ":asset:124")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.REQUESTING),
...
//                ),
    ...
    public void testAcceptSave_success(String name, ContractNegotiation contractNegotiation, List<ExtendableQuoteVO> negotiationQuotes, List<ExtendableQuoteItemVO> quoteItems, String expectedQuoteId, ExtendableQuoteUpdateVO expectedUpdate) {

        testSave_success(contractNegotiation, negotiationQuotes, quoteItems, expectedQuoteId, false, expectedUpdate);
    }
    ...
    public void testAgreeSave_success(String name, ContractNegotiation contractNegotiation, List<ExtendableQuoteVO> negotiationQuotes, List<ExtendableQuoteItemVO> quoteItems, String expectedQuoteId, ExtendableAgreementVO expectedAgreement, ExtendableQuoteUpdateVO expectedUpdate) {
        if (expectedAgreement != null) {
            when(tmfEdcMapper.toAgreement(eq(contractNegotiation.getId()), any())).thenReturn(expectedAgreement);
            when(tmfEdcMapper.toCreate(any(ExtendableAgreementVO.class))).thenAnswer(invocation -> {
        ...
        if (expectedAgreement != null) {
            ArgumentCaptor<ExtendableAgreementCreateVO> agreementCaptor = ArgumentCaptor.forClass(ExtendableAgreementCreateVO.class);
            ...
            assertEquals(AgreementState.IN_PROCESS.getValue(), createVO.getStatus(), "The agreement should be in process.");
            assertEquals(1, createVO.getAgreementItem().size(), "The terms and condition should have been added in state `under-negotiation`.");
            AgreementItemVO agreementItemVO = createVO.getAgreementItem().getFirst();
            assertEquals(1, agreementItemVO.getTermOrCondition().size(), "Terms and Conditions need to be included.");
        }
    }
    ...
    private static Stream<Arguments> getAgreeStates() {
        return Stream.of(
                Arguments.of(
                        ...
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.AGREED),
                        setActiveQuote(ContractNegotiationStates.AGREEING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5)),
                        List.of(getQuoteItem("123")),
                        "active-id",
                        null,
                ...
                Arguments.of(
                        ...
                        addAgreement(getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.AGREED)),
                        setActiveQuote(ContractNegotiationStates.AGREEING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5)),
                        List.of(getQuoteItem("123")),
                        "active-id",
                        getTestAgreement(),
                ...
                Arguments.of(
                        ...
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.AGREED),
                        setActiveQuote(ContractNegotiationStates.ACCEPTED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5)),
                        List.of(getQuoteItem("123")),
                        "active-id",
                        null,
                        expectedQuoteUpdate("AGREED", QuoteStateTypeVO.ACCEPTED, List.of(getQuoteItem("123")))
                ...
                Arguments.of(
                        ...
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.AGREEING),
                        setActiveQuote(ContractNegotiationStates.ACCEPTED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5)),
                        List.of(getQuoteItem("123")),
                        "active-id",
                        null,
                        expectedQuoteUpdate("AGREEING", QuoteStateTypeVO.ACCEPTED, List.of(getQuoteItem("123")))
                ),
                Arguments.of(
                        "[Provider]The negotiation should be transitioned from accepted to agreeing with the provided agreement included.",
                        addAgreement(getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.AGREEING)),
                        setActiveQuote(ContractNegotiationStates.ACCEPTED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5)),
                        List.of(getQuoteItem("123")),
                        "active-id",
                        getTestAgreement(),
    ...
    public void testVerificationSave_success(String name, ContractNegotiation contractNegotiation, List<ExtendableQuoteVO> negotiationQuotes, List<ExtendableQuoteItemVO> quoteItems, String participantId, ProductOrderVO existingOrder, String expectedQuoteId, ProductOrderCreateVO expectedProductOrder, ExtendableQuoteUpdateVO expectedUpdate) {
        ...
        tmfBackedContractNegotiationStore = new TMFBackedContractNegotiationStore(
                ...
                tmfEdcMapper, participantId,
                TEST_CONTROL_PLANE_ID, criterionOperatorRegistry,
                leaseHolder, lockManager);

        if (existingOrder != null) {
            when(productOrderApiClient.findByQuoteId(eq(expectedQuoteId))).thenReturn(List.of(existingOrder));
        }
        ...
        if (existingOrder != null) {
            ...
            ArgumentCaptor<ProductOrderCreateVO> productOrderCaptor = ArgumentCaptor.forClass(ProductOrderCreateVO.class);
            ...
            assertEquals(new HashSet<>(expectedProductOrder.getRelatedParty()), new HashSet<>(capturedProductOrder.getRelatedParty()), "All required related parties need to be included");
            assertEquals(new HashSet<>(expectedProductOrder.getQuote()), new HashSet<>(capturedProductOrder.getQuote()), "All quotes need to be included");
        }
    }
    ...
    private static Stream<Arguments> getVerificationStates() {
        return Stream.of(
                Arguments.of(
                        ...
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.VERIFYING, TEST_CONSUMER_ID),
                        setActiveQuote(ContractNegotiationStates.AGREED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED),
                        List.of(getQuoteItem("123")),
                        TEST_PROVIDER_ID,
                        null,
                        "active-id",
                        getProductOrderCreate("active-id", TMF_TEST_CONSUMER_ID, TMF_TEST_CONSUMER_ID, TMF_TEST_PROVIDER_ID),
                        expectedQuoteUpdate("VERIFYING", QuoteStateTypeVO.ACCEPTED, List.of(getQuoteItem("123")))
                ),
                Arguments.of(
                        "[Consumer]The negotiation should be transitioned from agreed to verifying.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.CONSUMER, ContractNegotiationStates.VERIFYING, TEST_PROVIDER_ID),
                        setActiveQuote(ContractNegotiationStates.AGREED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED),
                        List.of(getQuoteItem("123")),
                        TEST_CONSUMER_ID,
                        null,
                ...
                Arguments.of(
                        ...
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.VERIFIED, TEST_CONSUMER_ID),
                        setActiveQuote(ContractNegotiationStates.VERIFYING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED),
                        List.of(getQuoteItem("123")),
                        TEST_PROVIDER_ID,
                        null,
                        "active-id",
                        getProductOrderCreate("active-id", TMF_TEST_CONSUMER_ID, TMF_TEST_CONSUMER_ID, TMF_TEST_PROVIDER_ID),
                        expectedQuoteUpdate("VERIFIED", QuoteStateTypeVO.ACCEPTED, List.of(getQuoteItem("123")))
                ),
                Arguments.of(
                        "[Consumer]The negotiation should be transitioned from verifying to verified.",
                        getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.CONSUMER, ContractNegotiationStates.VERIFIED, TEST_PROVIDER_ID),
                        setActiveQuote(ContractNegotiationStates.VERIFYING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED),
                        List.of(getQuoteItem("123")),
                        TEST_CONSUMER_ID,
                        null,
    ...
    public void testFinalSave_success(String name, ContractNegotiation contractNegotiation, List<ExtendableQuoteVO> negotiationQuotes, List<ExtendableQuoteItemVO> quoteItems, ProductOrderVO existingOrder, String expectedQuoteId, ExtendableProductCreate expectedProduct, ExtendableQuoteUpdateVO expectedUpdate) {
        when(productOrderApiClient.findByQuoteId(eq(expectedQuoteId))).thenReturn(List.of(existingOrder));
        when(tmfEdcMapper.toUpdate(any(ProductOrderVO.class))).thenAnswer(invocation -> {
            ProductOrderVO productOrderVO = invocation.getArgument(0);
            return new TMFObjectMapperImpl().map(productOrderVO);
        });
        when(tmfEdcMapper.toUpdate(any(ExtendableAgreementVO.class))).thenAnswer(invocation -> {
        ...
        when(agreementApiClient.findByContractId(eq(contractNegotiation.getContractAgreement().getId()))).thenReturn(Optional.of(inProcessAgreementVO));

        testSave_success(contractNegotiation, negotiationQuotes, quoteItems, expectedQuoteId, false, expectedUpdate);

        ArgumentCaptor<ProductOrderUpdateVO> orderUpdateCaptor = ArgumentCaptor.forClass(ProductOrderUpdateVO.class);
        verify(productOrderApiClient, times(1)).updateProductOrder(eq(existingOrder.getId()), orderUpdateCaptor.capture());

        ArgumentCaptor<ExtendableProductCreate> productCreateCaptor = ArgumentCaptor.forClass(ExtendableProductCreate.class);
        verify(productInventoryApiClient, times(1)).createProduct(productCreateCaptor.capture());

        ArgumentCaptor<ExtendableAgreementUpdateVO> agreementUpdateCaptor = ArgumentCaptor.forClass(ExtendableAgreementUpdateVO.class);
        verify(agreementApiClient).updateAgreement(eq(inProcessAgreementVO.getId()), agreementUpdateCaptor.capture());

        assertEquals(ProductOrderStateTypeVO.COMPLETED, orderUpdateCaptor.getValue().getState(), "The order should be completed.");
        assertEquals(expectedProduct, productCreateCaptor.getValue(), "The product should have been created.");

        ExtendableAgreementUpdateVO updatedAgreement = agreementUpdateCaptor.getValue();
        assertEquals(AgreementState.AGREED.getValue(), updatedAgreement.getStatus(), "The agreement should now be agreed.");

        List<AgreementItemVO> agreementItemVOS = updatedAgreement.getAgreementItem();
        assertEquals(1, agreementItemVOS.size(), "The product should be the only item in the agreement.");
        ...
        assertEquals(createdProduct.getId(), productRefVOS.getLast().getId(), "The correct product should be referenced.");
    }
    ...
    private static Stream<Arguments> getFinalStates() {
        return Stream.of(
                Arguments.of(
                        ...
                        addAgreement(getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.FINALIZING, TEST_CONSUMER_ID)),
                        setActiveQuote(ContractNegotiationStates.VERIFIED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED, TEST_OFFER_ID),
                        List.of(getQuoteItem("123", TEST_OFFER_ID)),
                        getProductOrder(ProductOrderStateTypeVO.IN_PROGRESS),
                        "active-id",
                        getProductCreate("test-agreement-" + TEST_ASSET_ID, TMF_TEST_PROVIDER_ID, TMF_TEST_CONSUMER_ID, Optional.of(TEST_OFFER_ID)),
                        expectedQuoteUpdate("FINALIZING", QuoteStateTypeVO.ACCEPTED, List.of(getQuoteItem("123", TEST_OFFER_ID)))
                ),
                Arguments.of(
                        "[Provider]The negotiation should be transitioned from verified to finalized.",
                        addAgreement(getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.FINALIZED, TEST_CONSUMER_ID)),
                        setActiveQuote(ContractNegotiationStates.VERIFIED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED, TEST_OFFER_ID),
                        List.of(getQuoteItem("123", TEST_OFFER_ID)),
                        getProductOrder(ProductOrderStateTypeVO.IN_PROGRESS),
                        "active-id",
                        getProductCreate("test-agreement-" + TEST_ASSET_ID, TMF_TEST_PROVIDER_ID, TMF_TEST_CONSUMER_ID, Optional.of(TEST_OFFER_ID)),
                        expectedQuoteUpdate("FINALIZED", QuoteStateTypeVO.ACCEPTED, List.of(getQuoteItem("123", TEST_OFFER_ID)))
                ),
                Arguments.of(
                        "[Provider]The negotiation should be transitioned from finalizing to finalized.",
                        addAgreement(getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.PROVIDER, ContractNegotiationStates.FINALIZED, TEST_CONSUMER_ID)),
                        setActiveQuote(ContractNegotiationStates.FINALIZING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED, TEST_OFFER_ID),
                        List.of(getQuoteItem("123", TEST_OFFER_ID)),
                        getProductOrder(ProductOrderStateTypeVO.IN_PROGRESS),
                        "active-id",
                        getProductCreate("test-agreement-" + TEST_ASSET_ID, TMF_TEST_PROVIDER_ID, TMF_TEST_CONSUMER_ID, Optional.of(TEST_OFFER_ID)),
                ...
                Arguments.of(
                        ...
                        addAgreement(getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.CONSUMER, ContractNegotiationStates.FINALIZING, TEST_CONSUMER_ID)),
                        setActiveQuote(ContractNegotiationStates.VERIFIED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED, TEST_OFFER_ID),
                        List.of(getQuoteItem("123")),
                        getProductOrder(ProductOrderStateTypeVO.IN_PROGRESS),
                        "active-id",
                        getProductCreate("test-agreement-" + TEST_ASSET_ID, TMF_TEST_PROVIDER_ID, TMF_TEST_CONSUMER_ID, Optional.empty()),
                        expectedQuoteUpdate("FINALIZING", QuoteStateTypeVO.ACCEPTED, List.of(getQuoteItem("123")))
                ),
                Arguments.of(
                        "[Consumer]The negotiation should be transitioned from verified to finalized.",
                        addAgreement(getValidNegotiationWithIdOfferAndType(TEST_NEGOTIATION_ID, List.of(getOffer(TEST_OFFER_ID + ":asset:123")), ContractNegotiation.Type.CONSUMER, ContractNegotiationStates.FINALIZED, TEST_CONSUMER_ID)),
                        setActiveQuote(ContractNegotiationStates.VERIFIED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED, TEST_OFFER_ID),
                        List.of(getQuoteItem("123")),
                        getProductOrder(ProductOrderStateTypeVO.IN_PROGRESS),
                        "active-id",
                        getProductCreate("test-agreement-" + TEST_ASSET_ID, TMF_TEST_PROVIDER_ID, TMF_TEST_CONSUMER_ID, Optional.empty()),
                        expectedQuoteUpdate("FINALIZED", QuoteStateTypeVO.ACCEPTED, List.of(getQuoteItem("123")))
                ),
                Arguments.of(
    ...
    public void testTerminationSave_success(String name, ContractNegotiation contractNegotiation, List<QuoteProductHolder> negotiationQuotes, List<String> expectedOrderCancellations, List<String> expectedQuoteCancellation, Optional<String> expectedAgreementCancellation) {
        ...
        negotiationQuotes
                ...
                .peek(qph -> {
                    if (qph.productOrderVO() != null) {
                        when(productOrderApiClient.findByQuoteId(qph.extendableQuoteVO.getId())).thenReturn(List.of(qph.productOrderVO()));
                    }
                })
        ...
        expectedAgreementCancellation.ifPresent(agreementId -> {
        ...
        ArgumentCaptor<ProductOrderUpdateVO> orderUpdateCaptor = ArgumentCaptor.forClass(ProductOrderUpdateVO.class);
        ArgumentCaptor<ExtendableQuoteUpdateVO> quoteUpdateCaptor = ArgumentCaptor.forClass(ExtendableQuoteUpdateVO.class);

        verify(quoteApiClient, times(expectedQuoteCancellation.size())).updateQuote(quoteIdCaptor.capture(), quoteUpdateCaptor.capture());
        verify(productOrderApiClient, times(expectedOrderCancellations.size())).updateProductOrder(orderIdCaptor.capture(), orderUpdateCaptor.capture());

        assertEquals(new HashSet<>(expectedOrderCancellations), new HashSet<>(orderIdCaptor.getAllValues()), "All expected orders should have been cancelled.");
        assertEquals(new HashSet<>(expectedQuoteCancellation), new HashSet<>(quoteIdCaptor.getAllValues()), "All expected quotes should have been cancelled.");

        quoteUpdateCaptor.getAllValues()
                .forEach(equ -> assertEquals(QuoteStateTypeVO.CANCELLED, equ.getState(), "All quotes need to be updated to cancelled."));
        orderUpdateCaptor.getAllValues()
                .forEach(ou -> assertEquals(ProductOrderStateTypeVO.CANCELLED, ou.getState(), "All orders need to be updated to cancelled."));

        if (expectedAgreementCancellation.isPresent()) {
            ArgumentCaptor<ExtendableAgreementUpdateVO> agreementUpdateCaptor = ArgumentCaptor.forClass(ExtendableAgreementUpdateVO.class);
            verify(agreementApiClient, times(1)).updateAgreement(eq(expectedAgreementCancellation.get()), agreementUpdateCaptor.capture());
            assertEquals(AgreementState.REJECTED.getValue(), agreementUpdateCaptor.getValue().getStatus(), "The agreement should have been rejected.");
        }
    ...
    private static Stream<Arguments> getTerminations() {
        return Stream.of(
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        getWithoutProduct(setActiveQuote(ContractNegotiationStates.INITIAL, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.IN_PROGRESS)),
                        List.of(),
                        List.of("active-id"),
                        Optional.empty()
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        getWithoutProduct(setActiveQuote(ContractNegotiationStates.REQUESTING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.IN_PROGRESS)),
                        List.of(),
                        List.of("active-id"),
                        Optional.empty()
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        getWithoutProduct(setActiveQuote(ContractNegotiationStates.REQUESTED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.APPROVED)),
                        List.of(),
                        List.of("active-id"),
                        Optional.empty()
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        getWithoutProduct(setActiveQuote(ContractNegotiationStates.OFFERING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.APPROVED)),
                        List.of(),
                        List.of("active-id"),
                        Optional.empty()
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        getWithoutProduct(setActiveQuote(ContractNegotiationStates.OFFERED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.APPROVED)),
                        List.of(),
                        List.of("active-id"),
                        Optional.empty()
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        getWithoutProduct(setActiveQuote(ContractNegotiationStates.ACCEPTED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED)),
                        List.of(),
                        List.of("active-id"),
                        Optional.empty()
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        getWithoutProduct(setActiveQuote(ContractNegotiationStates.ACCEPTING, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED)),
                        List.of(),
                        List.of("active-id"),
                        Optional.empty()
                ),
                ...
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        getWithoutProduct(setActiveQuote(ContractNegotiationStates.AGREED, "active-id", getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5), QuoteStateTypeVO.ACCEPTED)),
                        List.of(),
                        List.of("active-id"),
                        Optional.of("test-agreement")
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        addQuoteProductHolder(getWithoutProduct(getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5, QuoteStateTypeVO.CANCELLED)), getWithProduct(getQuote("active-id", TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, QuoteStateTypeVO.ACCEPTED, ContractNegotiationStates.VERIFIED), "test-product")),
                ...
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        addQuoteProductHolder(getWithoutProduct(getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5, QuoteStateTypeVO.CANCELLED)), getWithProduct(getQuote("active-id", TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, QuoteStateTypeVO.ACCEPTED, ContractNegotiationStates.VERIFYING), "test-product")),
                        List.of("test-product"),
                        List.of("active-id"),
                        Optional.of("test-agreement")
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        addQuoteProductHolder(getWithoutProduct(getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5, QuoteStateTypeVO.CANCELLED)), getWithProduct(getQuote("active-id", TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, QuoteStateTypeVO.ACCEPTED, ContractNegotiationStates.FINALIZED), "test-product")),
                        List.of("test-product"),
                        List.of("active-id"),
                        Optional.of("test-agreement")
                ),
                Arguments.of(
                        ...
                        getValidNegotiationWithIdInState(TEST_NEGOTIATION_ID, ContractNegotiationStates.TERMINATED),
                        addQuoteProductHolder(getWithoutProduct(getQuotes(TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, 5, QuoteStateTypeVO.CANCELLED)), getWithProduct(getQuote("active-id", TEST_NEGOTIATION_ID, TEST_CONTROL_PLANE_ID, QuoteStateTypeVO.ACCEPTED, ContractNegotiationStates.TERMINATING), "test-product")),
                        List.of("test-product"),
                        List.of("active-id"),
                        Optional.of("test-agreement")
                )
    ...
    private static List<QuoteProductHolder> addQuoteProductHolder(List<QuoteProductHolder> quoteProductHolders, QuoteProductHolder quoteProductHolder) {
    ...
    private static List<QuoteProductHolder> getWithoutProduct(List<ExtendableQuoteVO> quoteVOS) {
        return new ArrayList<>(quoteVOS.stream()
                .map(extendableQuoteVO -> new QuoteProductHolder(extendableQuoteVO, null))
                .toList());
    }


    private record QuoteProductHolder(ExtendableQuoteVO extendableQuoteVO, ProductOrderVO productOrderVO) {
    }
    ...
    private static ExtendableProductCreate getProductCreate(String productId, String providerId, String consumerId, Optional<String> offeringId) {
        ...
        extendableProductCreate
                ...
                .addRelatedPartyItem(new org.seamware.tmforum.productinventory.model.RelatedPartyVO().id(providerId).role("Provider"))
                .addRelatedPartyItem(new org.seamware.tmforum.productinventory.model.RelatedPartyVO().id(consumerId).role("Consumer"));
        offeringId.ifPresent(id -> extendableProductCreate.productOffering(new ProductOfferingRefVO().id(id)));
    ...
    private static ProductOrderCreateVO getProductOrderCreate(String quoteId, String costumerId, String consumerId, String providerId) {
        ...
        productOrderCreateVO.addRelatedPartyItem(new org.seamware.tmforum.productorder.model.RelatedPartyVO().id(costumerId).role("Customer"));
        productOrderCreateVO.addRelatedPartyItem(new org.seamware.tmforum.productorder.model.RelatedPartyVO().id(consumerId).role("Consumer"));
        productOrderCreateVO.addRelatedPartyItem(new org.seamware.tmforum.productorder.model.RelatedPartyVO().id(providerId).role("Provider"));
    ...
    private static ExtendableQuoteItemVO getQuoteItem(String externalId, String offering) {
        ...
        extendableQuoteItemVO.setProductOffering(new org.seamware.tmforum.quote.model.ProductOfferingRefVO().id(offering));
    ...
    private static ExtendableQuoteUpdateVO expectedQuoteUpdate(String state, QuoteStateTypeVO quoteState, List<ExtendableQuoteItemVO> quoteItemVOS) {
        ContractNegotiationState expectedState = new ContractNegotiationState()
                .setState(state)
                .setControlplane(TEST_CONTROL_PLANE)
                .setCounterPartyAddress(TEST_COUNTER_PARTY_ADDRESS)
    ...
    private static List<ExtendableQuoteVO> setActiveQuote(ContractNegotiationStates activeState, String activeId, List<ExtendableQuoteVO> quoteVOS, QuoteStateTypeVO stateTypeVO) {
    ...
    private static List<ExtendableQuoteVO> setActiveQuote(ContractNegotiationStates activeState, String activeId, List<ExtendableQuoteVO> quoteVOS, QuoteStateTypeVO stateTypeVO, String offeringId) {
        List<ExtendableQuoteVO> extendableQuoteVOS = setActiveQuote(activeState, activeId, quoteVOS, stateTypeVO);
        ExtendableQuoteItemVO quoteItemVO = new ExtendableQuoteItemVO();
        quoteItemVO.productOffering(new org.seamware.tmforum.quote.model.ProductOfferingRefVO().id(offeringId));
