...
public class OID4VPConfigTest {
    ...
    public void testValidConfig(String testFile, OID4VPConfig expectedConfig) throws IOException {
        ...
        assertEquals(expectedConfig, OID4VPConfig.fromConfig(testConfig), "The config should have successfully been read.");
    }
    ...
    private static Stream<Arguments> getInvalidConfig() {
        return Stream.of(
                Arguments.of("invalid/1.properties", "When using OID4VP, the holder-id needs to be configured."),
                Arguments.of("invalid/2.properties", "For OID4VP, a valid key path needs to be configured."),
                Arguments.of("invalid/3.properties", "For OID4VP, a valid key type needs to be configured."),
                Arguments.of("invalid/4.properties", "If a proxy should be used for OID4VP, the proxy host needs to be configured.")
        );
    }
    ...
    private static Stream<Arguments> getValidConfig() throws IOException {
        ...
        OID4VPConfig oid4VPConfig1 = OID4VPConfig.Builder.newInstance()
                .enabled(true)
                .clientId("test")
        ...
        OID4VPConfig oid4VPConfig2 = OID4VPConfig.Builder.newInstance()
                .enabled(true)
                .clientId("test")
                .scope(Set.of("openid", "edc"))
                .trustAll(false)
        ...
        OID4VPConfig oid4VPConfig3 = OID4VPConfig.Builder.newInstance()
                .enabled(false)
